...
import 'donning3Sensor2.dart';

class Donning3Sensor1 extends StatelessWidget
{
  const Donning3Sensor1(
              ...
              AddNextImuButton (
                buttonText: 'Next Step',
                 callback:() {
                  ...
                  pageRoute: Donning3Sensor2(exercise: exercise, angleMetadata: angleMetadata)));
                }
              )
            ],
          )
