...
class ExercisesStreamBuilder extends StatefulWidget {
  ExercisesStreamBuilder(this._textController, {this.showLess});

  final TextEditingController _textController;
  static _ExercisesStreamBuilder streamBuilderState;
  static int numEvents = 0;
  List<Exercise> eventsUsed;
  bool showLess;

  @override
  _ExercisesStreamBuilder createState() => generateState();

  _ExercisesStreamBuilder generateState() {
    streamBuilderState = _ExercisesStreamBuilder();
    return streamBuilderState;
  }
}

class _ExercisesStreamBuilder extends State<ExercisesStreamBuilder> {
  String _searchValue = '';
  ...
  Widget build(BuildContext context) {
    ...
    if (filteredEvents != null && filteredEvents.isNotEmpty) {
      ExercisesStreamBuilder.numEvents = filteredEvents.length;
    }
